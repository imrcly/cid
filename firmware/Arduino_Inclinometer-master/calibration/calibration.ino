...
/*
   flat on the table (Z axis pointing up), adjust it until you obtain the maximum reading for the Z axis and make a note of it.
  upside down on the table (Z axis pointing down), adjust it until you obtain the minimum reading for the Z axis and make a note of it.
  standing on the table (X axis pointing up), read the maximum value for the X axis
  standing upside-down on the table (X axis pointing down), read the minimum value for the X axis
  sideways on the table (Y axis pointing up), read the maximum value for the Y axis
  sideways upside-down on the table (Y axis pointing down), read the minimum value for the Y axis
