...
void displaySensorDetails(void) {
  ...
  SerialUSB.println(gyro.name);
  SerialUSB.print("Driver Ver:   ");
  SerialUSB.println(gyro.version);
  SerialUSB.print("Unique ID:    0x");
  SerialUSB.println(gyro.sensor_id, HEX);
  SerialUSB.print("Max Value:    ");
  SerialUSB.print(gyro.max_value);
  SerialUSB.println(" rad/s");
  SerialUSB.print("Min Value:    ");
  SerialUSB.print(gyro.min_value);
  SerialUSB.println(" rad/s");
  SerialUSB.print("Resolution:   ");
  SerialUSB.print(gyro.resolution);
  SerialUSB.println(" rad/s");
  SerialUSB.println("------------------------------------");
  SerialUSB.println("");
...
void setup(void) {
  ...
  SerialUSB.println("Gyroscope Test");
  SerialUSB.println("");
...
void loop(void) {
  ...
  SerialUSB.print("X: ");
  SerialUSB.print(event.gyro.x);
  SerialUSB.print("  ");
  SerialUSB.print("Y: ");
  SerialUSB.print(event.gyro.y);
  SerialUSB.print("  ");
  SerialUSB.print("Z: ");
  SerialUSB.print(event.gyro.z);
  SerialUSB.print("  ");
  SerialUSB.println("rad/s ");
